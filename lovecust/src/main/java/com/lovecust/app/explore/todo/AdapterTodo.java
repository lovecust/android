...
public class AdapterTodo extends AlphaRecyclerViewAdapter< DataTodo > {
	...
	public void onBindViewHolder ( final AlphaRecyclerViewHolder holder, final int position ) {
		...
		holder.get( R.id.layout_parent ).setOnClickListener( new View.OnClickListener() {
			@Override
		...
		holder.get( R.id.iv_remove ).setOnClickListener( new View.OnClickListener() {
			@Override
			public void onClick ( View v ) {
		...
		holder.get( R.id.iv_done ).setOnClickListener( new View.OnClickListener() {
			@Override
			public void onClick ( View v ) {
		...
		holder.get( R.id.iv_edit ).setOnClickListener( new View.OnClickListener() {
			@Override
			public void onClick ( View v ) {
				todo.getText();
