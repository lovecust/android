...
//		ClassUtil.getFields( Build.VERSION.class );
	...
	* */
	public static void startActivityFromCenter(Activity activity, Class activityClass) {
		...
		activity.overridePendingTransition(R.anim.activity_zoom_in_from_center, R.anim.activity_zoom_out_from_center);
	}

	public static void startActivityFromRight(Activity activity, Class activityClass) {
		activity.startActivity(new Intent(activity, activityClass));
		activity.overridePendingTransition(R.anim.activity_push_in_from_right, R.anim.activity_push_out_from_left);
	}
